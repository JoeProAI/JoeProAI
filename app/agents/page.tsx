  ...
  return (
    <div className="min-h-screen pt-20 pb-10 px-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gradient">Grok Agents</h1>
            ...
            {showCreateAgent && (
              <div className="glass card-border p-4 space-y-3">
                <input
                  ...
                  className="w-full px-3 py-2 glass card-border bg-card-bg text-foreground text-sm"
                />
                <select
                  value={newAgent.type}
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 glass card-border bg-card-bg text-foreground text-sm resize-none"
                  rows={4}
                />
              ...
              {agents.map(agent => (
                <div
                  ...
                  className={`p-4 glass card-border cursor-pointer transition-all hover:card-border-hover ${
                    selectedAgent?.id === agent.id ? 'bg-primary/10 border-primary' : ''
                  }`}
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        {agent.type === 'vision' && <Eye className="w-4 h-4 text-primary" />}
                        {agent.type === 'analytics' && <TrendingUp className="w-4 h-4 text-primary" />}
